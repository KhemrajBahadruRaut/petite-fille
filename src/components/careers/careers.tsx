...
const WHY_WORK_WITH_US: WhyWorkWithUsItem[] = [
  {
    ...
    description:
      "Enjoy staff meals, coffee on us, and a supportive work environment where your contribution is recognised and rewarded.",
  },
  {
    id: "2",
    icon: Heart,
...
const normalizeRequirements = (
  requirements: JobsApiRecord["requirements"],
): string[] => {
...
const JobListItem = React.memo(
  ({
    ...
    <motion.div
      ...
      className={`p-4 sm:p-6 border-b border-gray-200 cursor-pointer transition-all duration-200 hover:bg-gray-50 ${
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div
            className="grid grid-cols-1 items-start lg:grid-cols-5 gap-6 lg:gap-8"
      ...
      >
        ...
        >
          <p
            ...
            style={{ fontFamily: "arial" }}
          >
            <span className="text-[#EEC27E] font-medium">
