...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    price: "$70",
    description:
      "Crackers, fresh baguettes, dry fruits, cashews, walnuts, mixed cheese & capers (6–8 people)",
  },
  {
  ...
  },
  {
    ...
    price: "$18 per person",
    description:
      "Mini egg & bacon roll, mini pumpkin & feta quiche and yoghurt granola bowl (10 people min)",
  },
  {
    name: "Baguettes",
    price: "$13 per person",
  ...
  return (
    <section className="bg-white text-center overflow-hidden pt-25">
      <h1 className="sr-only">
        Catering Services by Petite Fille – Rosanna, Melbourne
      </h1>
      {/* Heading */}
      <motion.div
        initial="hidden"
      ...
      >
        ...
        >
          From your daily ritual to your special events, we bring quality and
          care to every cup and every plate.
        </motion.p>
      </motion.div>
