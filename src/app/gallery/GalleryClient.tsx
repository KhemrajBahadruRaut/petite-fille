    ...
    <div className="bg-white pb-20 pt-10">
      <section className="py-16 px-4 container mx-auto">
        <motion.div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4" style={{ fontFamily: 'fairplaybold' }}>Our Gallery – Petite Fille Cafe Rosanna</h1>
        ...
        <div className="space-y-8">
          {rows.map((row, i) => {
            const rowContent = row.images.map((img, imgIndex) => (
              <button
                key={img.id}
        ...
        {selectedImage && (
          ...
          >
            <motion.div className="relative max-w-4xl w-full max-h-full">
              ...
              <img
                src={selectedImage}
                alt="Petite Fille Cafe Rosanna gallery photo enlarged view"
